...
export function createUnavailableApi(): PalermoApi {
  ...
  return {
    ...
    admin: {
      ...
      listReviews: unavailable, moderateReview: unavailable,
      listPromotions: unavailable, listPromotionalContent: unavailable,
      createPromotion: unavailable, updatePromotion: unavailable,
